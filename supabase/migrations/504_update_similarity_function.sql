-- 504: Update similarity function for 1024-dimensional embeddings
-- Purpose: Update RPC function to use Voyage AI dimensions
...
COMMENT ON FUNCTION find_similar_patterns IS 'Find patterns similar to target embedding using cosine distance (Voyage AI 1024-dim)';
